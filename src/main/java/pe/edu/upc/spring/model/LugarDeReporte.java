...
@Entity
@Table(name="LugarDeReporte")
public class LugarDeReporte implements Serializable {
	...
	public LugarDeReporte() {
		super();

	}

	public LugarDeReporte(int cDireccion, String nDireccion, String numDireccion, Distrito distrito, TipoVia tipovia) {
		super();
